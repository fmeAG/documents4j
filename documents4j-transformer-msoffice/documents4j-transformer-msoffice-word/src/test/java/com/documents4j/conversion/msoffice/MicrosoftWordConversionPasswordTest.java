...
public class MicrosoftWordConversionPasswordTest extends AbstractMicrosoftOfficeConversionTest {

    public MicrosoftWordConversionPasswordTest(Document valid,
                                               Document corrupt,
                                               Document inexistent,
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
               {DOC_PASSWORD, DOC_CORRUPT, DOC_INEXISTENT, DocumentType.DOC, DocumentType.PDF, "pdf", false},
               {OTT_PASSWORD, DOC_CORRUPT, DOC_INEXISTENT, DocumentType.OTT, DocumentType.DOTX, "dotx", false}
